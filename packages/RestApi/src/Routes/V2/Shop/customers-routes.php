...
use Webkul\RestApi\Http\Controllers\V2\Shop\Customer\AddressController;
use Webkul\RestApi\Http\Controllers\V2\Shop\Customer\AuthController;
use Webkul\RestApi\Http\Controllers\V2\Shop\Customer\CartController;
use Webkul\RestApi\Http\Controllers\V2\Shop\Customer\CheckoutController;
use Webkul\RestApi\Http\Controllers\V2\Shop\Customer\InvoiceController;
use Webkul\RestApi\Http\Controllers\V2\Shop\Customer\OrderController;
use Webkul\RestApi\Http\Controllers\V2\Shop\Customer\ShipmentController;
use Webkul\RestApi\Http\Controllers\V2\Shop\Customer\TransactionController;
use Webkul\RestApi\Http\Controllers\V2\Shop\Customer\WishlistController;
use Webkul\RestApi\Http\Controllers\V2\Shop\Customer\NewsLetterController;
use Webkul\RestApi\Http\Controllers\V2\Shop\Customer\GDPRController;
use Webkul\RestApi\Http\Controllers\V2\Shop\Customer\FastCartController;
...
Route::group(['middleware' => ['auth:sanctum', 'sanctum.customer']], function () {
    ...
    /**
     * Customer fast cart routes.
     */
    Route::controller(FastCartController::class)->prefix('customer/cart')->group(function () {
        Route::get('fast', 'show');
    });

...
class ReOrderController
{
    /**
     * @OA\Post(
     *      path="/api/v2/admin/sales/re-orders/{id}",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/admin/sales/re-orders/{id}/save-address",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/admin/sales/re-orders/{id}/save-shipping",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/admin/sales/re-orders/{id}/save-payment",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/admin/sales/re-orders/{id}/save-order",

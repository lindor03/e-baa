...
class ProductController
{
    /**
     * @OA\Get(
     *      path="/api/v2/admin/catalog/products",
    ...
    /**
     * @OA\Get(
     *      path="/api/v2/admin/catalog/products/{id}",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/admin/catalog/products/{id}/inventories",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/admin/catalog/products/mass-update",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/admin/catalog/products/mass-destroy",

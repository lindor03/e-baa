...
class CategoryController
{
    /**
     * @OA\Get(
     *      path="/api/v2/admin/catalog/categories",
    ...
    /**
     * @OA\Get(
     *      path="/api/v2/admin/catalog/categories/{id}",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/admin/catalog/categories/mass-update",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/admin/catalog/categories/mass-destroy",

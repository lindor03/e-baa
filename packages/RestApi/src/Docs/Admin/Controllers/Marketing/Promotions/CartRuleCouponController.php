...
class CartRuleCouponController
{
    /**
     * @OA\Get(
     *      path="/api/v2/admin/promotions/cart-rules/{cart_rule_id}/coupons",
    ...
    /**
     * @OA\Get(
     *      path="/api/v2/admin/promotions/cart-rules/{cart_rule_id}/coupons/{id}",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/admin/promotions/cart-rules/{cart_rule_id}/coupons/mass-destroy",

...
class URLRewriteController
{
    /**
     * @OA\Get(
     *      path="/api/v2/admin/marketing/search-seo/url-rewrites",
    ...
    /**
     * @OA\Get(
     *      path="/api/v2/admin/marketing/search-seo/url-rewrites/{id}",
    ...
    *                  @OA\Property(
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/admin/marketing/search-seo/url-rewrites/mass-destroy",

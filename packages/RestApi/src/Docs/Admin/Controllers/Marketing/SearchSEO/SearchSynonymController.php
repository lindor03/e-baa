...
class SearchSynonymController
{
    /**
     * @OA\Get(
     *      path="/api/v2/admin/marketing/search-seo/search-synonyms",
    ...
    /**
     * @OA\Get(
     *      path="/api/v2/admin/marketing/search-seo/search-synonyms/{id}",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/admin/marketing/search-seo/search-synonyms/mass-destroy",

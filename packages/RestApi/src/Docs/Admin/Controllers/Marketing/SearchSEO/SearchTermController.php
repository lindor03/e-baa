...
class SearchTermController
{
    /**
     * @OA\Get(
     *      path="/api/v2/admin/marketing/search-seo/search-terms",
    ...
    /**
     * @OA\Get(
     *      path="/api/v2/admin/marketing/search-seo/search-terms/{id}",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/admin/marketing/search-seo/search-terms/mass-destroy",

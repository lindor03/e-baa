...
class ReviewController
{
    /**
     * @OA\Get(
     *      path="/api/v2/admin/customers/reviews",
    ...
    /**
     * @OA\Get(
     *      path="/api/v2/admin/customers/reviews/{id}",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/admin/customers/reviews/mass-destroy",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/admin/customers/reviews/mass-update",

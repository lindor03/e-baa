...
class CustomerController
{
    ...
    /**
     * @OA\Get(
     *      path="/api/v2/admin/customers/{id}",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/admin/customers/mass-update",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/admin/customers/mass-destroy",
    ...
    /**
     * @OA\Get(
     *      path="/api/v2/admin/customers/{id}/orders",
    ...
    /**
     * @OA\Get(
     *      path="/api/v2/admin/customers/{id}/invoices",
    ...
    /**
    * @OA\Post(
    *      path="/api/v2/admin/customers/{id}/notes",

...
class AddressController
{
    /**
     * @OA\Get(
     *      path="/api/v2/admin/customers/{customer_id}/addresses",
    ...
    /**
     * @OA\Get(
     *      path="/api/v2/admin/customers/{customer_id}/addresses/{id}",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/admin/customers/{customer_id}/addresses/mass-destroy",

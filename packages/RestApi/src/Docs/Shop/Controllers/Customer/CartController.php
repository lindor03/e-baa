...
class CartController
{
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/customer/cart/add/{productId}",
    ...
    /**
     * @OA\Put(
     *      path="/api/v2/customer/cart/update",
    ...
    /**
     * @OA\Delete(
     *      path="/api/v2/customer/cart/remove/{cartItemId}",
    ...
    /**
     * @OA\Delete(
     *      path="/api/v2/customer/cart/remove",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/customer/cart/move-to-wishlist/{cartItemId}",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/customer/cart/coupon",

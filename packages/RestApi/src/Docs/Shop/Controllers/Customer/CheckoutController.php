...
class CheckoutController
{
    /**
     * @OA\Post(
     *      path="/api/v2/customer/checkout/save-address",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/customer/checkout/save-shipping",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/customer/checkout/save-payment",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/customer/checkout/check-minimum-order",
    ...
    /**
     * @OA\Post(
     *      path="/api/v2/customer/checkout/save-order",

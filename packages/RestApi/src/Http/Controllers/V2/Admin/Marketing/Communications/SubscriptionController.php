...
namespace Webkul\RestApi\Http\Controllers\V2\Admin\Marketing\Communications;

use Illuminate\Http\Response;
use Illuminate\Support\Facades\Event;
use Webkul\Core\Repositories\SubscribersListRepository;
use Webkul\RestApi\Http\Controllers\V2\Admin\Marketing\MarketingController;
use Webkul\RestApi\Http\Resources\V2\Admin\Marketing\Communications\SubscriptionResource;
